...
public class ListTester {
	...
	private void runTests() {
		...
		/*testSingleElementList(A_removeFirst_emptyList, "A_removeFirst_emptyList", LIST_, STRING_);
		testSingleElementList(A_removeLast_emptyList, "A_removeLast_emptyList", LIST_, STRING_A);
		testSingleElementList(A_removeA_emptyList, "A_removeA_emptyList", LIST_A, STRING_);
		testSingleElementList(A_remove0_emptyList, "A_remove0_emptyList", LIST_A, STRING_A);
		*/
		//1-element to 2-element
		testTwoElementList(A_addToFrontB_BA, "A_addToFrontB_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_addToRearB_AB, "A_addToRearB_BB", LIST_BA, STRING_BA);
		testTwoElementList(A_addIndex0B_BA, "A_addIndex0B_BA", LIST_BA, STRING_BA);
		testTwoElementList(A_addIndex1B_AB, "A_addIndex1B_AB", LIST_BA, STRING_BA);
...
//			break;
	...
	/** Scenario: empty list -> addAt0(A) -> [A] 
	 * @return [A] after addToFront(A)
	 */
